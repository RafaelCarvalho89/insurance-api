...
require 'spec_helper'
require_relative '../../../../../app/core/home_insurance/services/risk_scorer'

RSpec.describe HomeInsuranceRiskScorer do # rubocop:disable Metrics/BlockLength
